...
echo Run The Demo Test Scenario

echo Define user accounts Id
...
echo Create account for user 0
...
echo Create account for user 1
...
echo Wait until the receipt becomes available
...
echo Get the receipt for the transfer
