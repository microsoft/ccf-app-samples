...
curl $reportUrl -X GET $(cert_arg member1) | jq > ../../demo/Reports/Member1_Code_Change_V1.json
...
curl $reportUrl -X GET $(cert_arg member1) | jq > ../../demo/Reports/Member1_Code_Change_V2.json
