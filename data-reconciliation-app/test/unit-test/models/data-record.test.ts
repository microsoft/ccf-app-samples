...
describe('Data Record Model', () => {
    ...
    test('Should Fail To Create With Empty Key', () => {
        ...
        expect(createDataRecord.error?.errorMessage).toBe('Error: key cannot be null or empty');
    });
    ...
    test('Should fail to create with empty value', () => {
        ...
        expect(createDataRecord.error?.errorMessage).toBe('Error: value cannot be null or empty');
    });
});
