...
const openApiDoc = {
  ...
  info: {
    ...
    description:
      "The data reconciliation service is hosted on the CCF network, where users/members can submit their data to be reconciled against each other's data in a confidential manner and generate some data insights as a report",
    version: "1.0.0",
  },
  security: [{ Bearer: [] }],
  servers: [],
  components: {
    ...
    schemas: {
        ...
        properties: {
          error: {
            properties: {
              code: {
                description:
                  "Response error code. CCF error codes: https://microsoft.github.io/CCF/main/operations/troubleshooting.html#error-codes",
                type: "string",
              },
              message: {
      ...
      EndpointMetricsEntry: {
        ...
        required: ["path", "method", "calls", "errors", "failures", "retries"],
        type: "object",
      },
    ...
    "x-ccf-forwarding": {
      always: {
        description:
          "If this request is made to a backup node, it will be forwarded to the primary node for execution.",
        value: "always",
      },
      never: {
        description:
          "This call will never be forwarded, and is always executed on the receiving node, potentially breaking session consistency. If this attempts to write on a backup, this will fail.",
        value: "never",
      },
      sometimes: {
        description:
          "If this request is made to a backup node, it may be forwarded to the primary node for execution. Specifically, if this request is sent as part of a session which was already forwarded, then it will also be forwarded.",
        value: "sometimes",
      },
    },
  },
  paths: {
    ...
    "/app/csv/ingest": {
      post: {
        description:
          "Users or members submit their data to be reconciled in csv formate",
        summary: "Ingest data to be reconciled",
        tags: ["Application API"],
        requestBody: {
          required: true,
    ...
    "/app/report/{id}": {
      get: {
        description:
          "Get the data reconciliation report for specified record by supplying record id",
    ...
    "/app/commit": {
      get: {
        ...
        summary:
          "Current commit level, Latest transaction ID that has been committed on the service",
        tags: ["Metrics API"],
        responses: {
          "200": {
            content: {
    ...
    "/app/receipt": {
      get: {
        ...
        summary:
          "Get a signed statement from the service over a transaction entry in the ledger",
        tags: ["Metrics API"],
        parameters: [
          {
            in: "query",
    ...
    "/app/tx": {
      get: {
        ...
        summary:
          "get current status of a transaction, Possible statuses returned are Unknown, Pending, Committed or Invalid.",
        tags: ["Metrics API"],
        parameters: [
          {
            in: "query",
